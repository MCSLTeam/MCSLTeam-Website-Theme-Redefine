! function (e, t) {
    ...
    class s {
        ...
        _afterUnmount() { }
        _checkRequirements() {
            return "object" != typeof this.requires || Object.entries(this.requires).forEach(([e, s]) => {
                if (! function (e, s, n) {
                    const r = function (e, t) {
                        ...
                        if ("swup" === e) return null != (s = t.version) ? s : ""; {
                            ...
                            return null != (n = null == s ? void 0 : s.version) ? n : ""
                        }
                    }(e, n);
                    return !!r && ((e, s) => s.every(s => {
                        const [, n, r] = s.match(/^([\D]+)?(.*)$/) || [];
                        var i, o;
                        return ((e, t) => {
                            const s = {
                            ...
                            return (s[t] || s[""])(e)
                        })((o = r, i = t(i = e), o = t(o), i.localeCompare(o, void 0, {
                            numeric: !0
                        })), n || ">=")
                    }))(r, s)
    ...
    class n extends s {
        constructor(...e) {
            super(...e), this._addedStyleElements = [], this._addedHTMLContent = [], this._classNameAddedToElements = [], this._addClassNameToElement = () => {
        ...
        _afterUnmount() {
            this.swup.options.animationSelector = this._originalAnimationSelectorOption, this._addedStyleElements.forEach(e => {
                e.outerHTML = "", e = null
        ...
        applyStyles(e) {
            ...
            t.setAttribute("data-swup-theme", ""), t.appendChild(document.createTextNode(e)), document.head.prepend(t), this._addedStyleElements.push(t)
        }
        applyHTML(e) {
            const t = document.createElement("div");
            t.innerHTML = e, document.body.appendChild(t), this._addedHTMLContent.push(t)
        }
        addClassName(e, t) {
    ...
    return class extends n {
        constructor(e) {
            void 0 === e && (e = {}), super(), this.name = "SwupSlideTheme", this.defaults = {
                mainElement: "#swup",
                reversed: !1
            }, this.options = {
                ...this.defaults,
